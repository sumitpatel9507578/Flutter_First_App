...
import '../Programing/getUser.dart';
import 'rest_api_helper.dart';
import 'Rest_api.dart';
import 'package:flutter/material.dart';
                ...
                return Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Name: ${user.empName}",style: TextStyle(fontWeight: FontWeight.bold),),
                        Text("Email: ${user.empEmail ?? ""}"),
                        Text("Phone: ${user.empPhone}"),
                        Text("Company: ${user.empDepartment ?? ""}"),
                        Text("Role: ${user.empSalary}"),
                      ],
                    ),
                  ),
                );
